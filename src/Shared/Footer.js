...
const Footer = () => {
    return (
        <footer class="footer footer-center p-10 bg-white">
            ...
            <div>
                <footer>
                    <p>
                        ...
                        <Link target="_blank"to='' >Hossain Sarker</Link>
                        - Read how I created this
                        <Link target="_blank" to=''>here</Link>
                        - Design made by
                        <Link target="_blank" to='' >Hossain</Link>
                    </p>
                </footer>
            </div>
        </footer>
