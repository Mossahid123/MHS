...
const Blogs = () => {
    return (
        <div>
            <div className='mt-12 w-10/12 mx-auto grid grid-cols-2 gap-5'>
                <div>
                    <h2 className='text-3xl mb-2'>How will you improve the performance of a React Application</h2>
                    <p>
                ...
                <div>
                    ...
                    <h2 className='text-3xl mb-2'>How does prototypical inheritance work?</h2>
                    <p>
                ...
                <div>
                    ...
                    <h2 className='text-3xl mb-2'> What is a unit test? Why should write unit tests?</h2>
                ...
                <div>
                    ...
                    <h2 className='text-3xl mb-2'> You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h2>
                    <p>by user filter</p>
                </div>
            </div>
        </div>
